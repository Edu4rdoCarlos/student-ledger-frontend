...
import { User, Trophy, Mail, GraduationCap, Calendar, CheckCircle2, XCircle, Clock, MapPin, Users, Briefcase } from "lucide-react"
...
export function AdvisorDetailsModal({ advisor, open, onOpenChange, loading = false }: AdvisorDetailsModalProps) {
